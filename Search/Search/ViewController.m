...
@property (strong,nonatomic) ResultsVC *resultVC; //搜索结果展示控制器
...
- (void)viewDidLoad {
    ...
    //tableView
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 94, self.view.frame.size.width, self.view.frame.size.height - 94) style:UITableViewStylePlain];
    ...
    //UISearchController
    //创建显示搜索结果控制器
    _resultVC = [[ResultsVC alloc] init];
